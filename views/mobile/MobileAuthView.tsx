          ...
          {!isLogin && (
            <div className="flex items-start gap-2.5 pt-1">
              ...
              <label htmlFor="terms" className="text-[10px] text-emerald-400/90 leading-relaxed cursor-pointer font-medium select-none">
                I agree to the <a href="https://roopchandu96-netizen.github.io/bharath-film-industry/#terms" target="_blank" rel="noopener noreferrer" className="font-bold text-[#FACC15] hover:underline">Terms of Service</a> and <a href="https://roopchandu96-netizen.github.io/bharath-film-industry/#privacy" target="_blank" rel="noopener noreferrer" className="font-bold text-[#FACC15] hover:underline">Privacy Policy</a>. I understand this is a financial investment platform.
              </label>
            </div>
          )}
