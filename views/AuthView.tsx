              ...
              <form onSubmit={startAuthFlow} className="space-y-5">
                ...
                <div className="flex items-start gap-3 pt-2">
                  ...
                  <label htmlFor="terms" className="text-[11px] text-zinc-600 leading-relaxed font-medium block">
                    I agree to the <a href="https://roopchandu96-netizen.github.io/bharath-film-industry/#terms" target="_blank" rel="noopener noreferrer" className="font-bold text-amber-600 hover:underline">Terms of Service</a> and <a href="https://roopchandu96-netizen.github.io/bharath-film-industry/#privacy" target="_blank" rel="noopener noreferrer" className="font-bold text-amber-600 hover:underline">Privacy Policy</a>. I understand this is a financial investment platform.
                  </label>
                </div>
